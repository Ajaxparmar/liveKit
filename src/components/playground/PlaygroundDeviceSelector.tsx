...
export const PlaygroundDeviceSelector = ({
  ...
  return (
    <div>
      <button
        className="flex gap-2 items-center px-2 py-1 bg-gray-900 text-gray-300 rounded-sm hover:bg-gray-800"
        onClick={(e) => {
      ...
      <div
        className="absolute right-4 top-12 bg-gray-800 text-gray-300 rounded-sm z-10"
        style={{
